========================================================================
    ACTIVE TEMPLATE LIBRARY : AtlEventServer Project Overview
========================================================================

AppWizard has created this AtlEventServer project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

AtlEventServer.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

AtlEventServer.vcxproj.filters
...
AtlEventServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AtlEventServer.h)
        GUID definitions                                (AtlEventServer_i.c)
        A type library                                  (AtlEventServer.tlb)
        Marshaling code                                 (AtlEventServer_p.c and dlldata.c)

AtlEventServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AtlEventServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named AtlEventServer.pch and a precompiled types file named StdAfx.obj.
...
AtlEventServerps.vcxproj
	...
	dlldata.c, AtlEventServer_i.c and AtlEventServer_p.c which are required
	to build the proxy/stub DLL.

AtlEventServerps.vcxproj.filters
